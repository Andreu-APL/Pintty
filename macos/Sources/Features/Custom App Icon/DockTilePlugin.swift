...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.pintty.Pintty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "com.pintty.Pintty")
    #endif
